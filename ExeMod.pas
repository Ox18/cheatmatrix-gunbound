...
procedure ReplaceInString(DemarcStr, ReplacementString:
 AnsiString; var String2Alter: AnsiString);
...
procedure String2Stream(a: AnsiString; var b: TMemoryStream);
procedure Stream2String(b: TMemoryStream;var a: AnsiString);
...
begin
 ...
 if Pos(uppercase('so!#' + DemarcStr + AnsiChar(182)), Exe) > 0 then
 begin
   d := Pos(uppercase('so!#' + DemarcStr + AnsiChar(182)), Exe)
     + length(uppercase('so!#' + DemarcStr + AnsiChar(182)));
...
begin
 ...
 if Pos(uppercase('so!#' + DemarcStr + AnsiChar(182)), Temp) > 0 then
 begin
   d := Pos(uppercase('so!#' + DemarcStr + AnsiChar(182)), Temp)
     + length(uppercase('so!#' + DemarcStr + AnsiChar(182)));
...
var
 a, b: AnsiString;
begin
 a := UpperCase('so!#' + DemarcStr + AnsiChar(182));
...
begin
 ...
 MyString := File2String(FileName);
 MyString := MyString + uppercase('so!#' + DemarcStr + AnsiChar(182)) + String2Add + uppercase
   ('eo!#' + DemarcStr);
 String2File(MyString, FileName);
end;
//===================================================
...
begin
 If DemarcStr = '' then Exit;
 String2Alter := String2Alter + uppercase('so!#' + DemarcStr + AnsiChar(182))
...
begin
 If DemarcStr = '' then Exit;
 if pos(uppercase('so!#' + DemarcStr + AnsiChar(182)), String2Alter) = 0 then exit;
...
begin
 If DemarcStr = '' then Exit;
 if pos(uppercase('so!#' + DemarcStr + AnsiChar(182)), Exe) = 0 then exit;
 DelFromString(DemarcStr, Exe);
