...
#include "..\..\Plugins\Aimbot\pixelUnit.h"
#include "..\..\Plugins\mathUtils.h"
#include "..\..\Plugins\Aimbot\tornado.h"
#include "estruturaBot.h"
#include "efeitosTeste.h"
...
class TShMatrix {
	...
	public:
		...
		void __fastcall fillPoints(int px, int py);
		void __fastcall fillPoints(HDC dc, int px, int py);
