...
unit lvkInternet deprecated;
// New unit name is lvkWinInet.pas
// lvkInternet.pas will be deleted in a future version, please fix your
// references to use lvkWinInet instead.
...
// $Revision: 9 $
// $Date: 16.04.03 10:50 $
// $Archive: /Components/LVK/source/lvkInternet.pas $

{$I VERSIONS.INC}
{$I DIRECTIVES.INC}

uses
  SysUtils, Classes, WinInet, lvkRegExp, lvkThread, lvkVersion;
...
type
  ...
  protected
    ...
    function ConnectToServer(
      const Session: IInternetSession): HINTERNET; virtual; abstract;
...
begin
  ...
  { TODO 2 -oLVK -cSource : Handle attributes }
  if not FtpGetFile(Handle, PChar(RemoteFilename), PChar(LocalFilename), False,
    0, FTPTransferTypes[TransferType] or ReloadFlag[ForceReload],
...
const
  { TODO 2 -oLVK -cSource : Handle the rest of the error codes }
  ErrorCodes  : array[1..85] of TWinInetError = (
    ...
    (ErrorCode    : ERROR_INTERNET_EXTENDED_ERROR;
     ...
     Description  : 'An extended error was returned from the server. This is ' +
    ...
    (ErrorCode    : ERROR_INTERNET_BAD_OPTION_LENGTH;
     ...
     Description  : 'The length of an option supplied to InternetQueryOption or ' +
    ...
    (ErrorCode    : ERROR_INTERNET_SHUTDOWN;
     ...
     Description  : 'The Win32 Internet function support is being shut down or ' +
                    'unloaded.'),
    (ErrorCode    : ERROR_INTERNET_INCORRECT_USER_NAME;
     ID           : 'ERROR_INTERNET_INCORRECT_USER_NAME';
     Description  : 'The request to connect and log on to an FTP server could ' +
    ...
    (ErrorCode    : ERROR_INTERNET_OPERATION_CANCELLED;
     ...
     Description  : 'The operation was canceled, usually because the handle on ' +
    ...
    (ErrorCode    : ERROR_INTERNET_INCORRECT_HANDLE_STATE;
     ...
     Description  : 'The requested operation cannot be carried out because the ' +
    ...
    (ErrorCode    : ERROR_INTERNET_BAD_REGISTRY_PARAMETER;
     ...
     Description  : 'A required registry value was located but is an incorrect ' +
    ...
    (ErrorCode    : ERROR_INTERNET_NO_CONTEXT;
     ...
     Description  : 'An asynchronous request could not be made because a zero ' +
    ...
    (ErrorCode    : ERROR_INTERNET_REQUEST_PENDING;
     ...
     Description  : 'The required operation could not be completed because one ' +
    ...
    (ErrorCode    : ERROR_INTERNET_FORCE_RETRY;
     ...
     Description  : 'Calls for the Win32 Internet function to redo the request.'),
...
begin
  ...
  if StatusCode in HTTP_ACCEPTABLE_STATUS_CODES then
