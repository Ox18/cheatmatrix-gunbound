...
VMProtectBegin("cst");
	...
	if(linguagem == PT_BR){
		switch(id){
			...
			case 30: return "Próximo Mobile";
			case 31: return "Mobile Anterior";
			case 32: return "Próximo Alvo";
			case 33: return "Alvo Anterior";
			case 34: return "Próximo modo de mira";
			...
			case 53: return "Tiro composto de Dragão";
			case 54: return "Tiro composto de Raon";
			case 55: return "Tiro composto de Frank";
			case 56: return "Inversão de Nak";
			case 57: return "Raio(s) de A.Sate";
			case 58: return "Marcar SS";
			case 59: return "Descrição";
			case 60: return "Dicas";
			case 61: return "          Dá uma noção de força/distancia para um lançamento de projétil, com ação de forças externas, para GB. É um aimbot longo alcance, ou seja, pode mirar de qualquer parte para qualquer outra parte do mapa.";
			case 62: return "     -=> Se estiver no modo MOUSE, pressione CTRL para parar a mira no local atual, para que possa atirar com o mouse ou movê-lo sem alterar a posição da mira e quantidade de força indicada pelo aim.";
			case 63: return "Atalho";
			case 64: return "Selecionar alvo";
			case 65: return "desconhecido";
			case 66: return "Este atalho já está em uso!";
			case 67: return "Atenção";
			case 68: return "Você deve reiniciar o CMX para que as modificações tenham efeito.";
		}
	} else {
    	switch(id){
			...
			case 53: return "Composite Shot of Dragão";
