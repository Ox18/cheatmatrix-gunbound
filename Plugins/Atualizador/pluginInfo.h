...
extern const char*	 		Hack_Name 	= "Atualizador";  //** Nome do Hack
...
extern const unsigned long	Hack_Code 	= 402236656;   //** Codigo do Hack
extern const short			MinimumPackets = 13;        //** Quantidade de Pacotes de ponteiros
extern const char*	 		Hack_Nick 	= Hack_Name;    // Nome do Hack
extern const char*	 		Hack_Label 	= "Atualizador";
