  ...
  begin
    ...
    begin
      ...
      case index of
        0009:
          begin
            result := 'Falha na conexão com o servidor';
          end;
        0010:
          begin
            result := 'Checando consistência dos dados...';
          end;
        0011:
          begin
            result :=
              'Erro na conexão com o servidor! Reinicie o CM e tente novamente.';
          end;
        0012:
          begin
            result := 'Verificando Conexão...';
          end; // ny0RthvvVhwScIDfSSCWwaopzCn6rQQhJBxCLsCxOso=
        0031:
          begin
            result := 'Plugin inválido (';
          end;
        0032:
          begin
            result := 'Falha ao carregar o plugin ';
          end;
        0042:
          begin
            result := 'Carregando Plugins...';
          end;
        0044:
          begin
        ...
        0052:
          begin
            result := 'Pressione F1 se precisar de ajuda';
          end;
        0055:
          begin
            result := 'Erro ao carregar as configurações. Arquivo modificado.';
          end;
        0080:
          begin
            result := 'Incompatibilidade de versão entre os arquivos';
          end;
        0089:
          begin
        ...
        0167:
          begin
            result := 'Atualizando arquivos, aguarde... ';
          end;
        0174:
          begin
            result := 'Arquivo de download não encontrado!';
          end;
        0175:
          begin
            result := 'Falha ao baixar o arquivo de atualização!';
          end;
        0176:
          begin
            result := 'Falha ao salvar o arquivo de atualização!';
          end;
        0177:
          begin
            result := 'Servidor sobrecarregado. Tente novamente mais tarde!';
          end;
    ...
    begin
      case index of
        ...
        0010:
          begin
            result := 'Checking data consistency ...';
          end;
        0011:
          begin
            result :=
              'Error connecting to server! Restart the CMX and try again.';
          end;
        0012:
          begin
        ...
        0032:
          begin
            result := 'Failed to load plugin ';
          end;
        0042:
          begin
            result := 'Loading Plugins...';
          end;
        0044:
          begin
        ...
        0055:
          begin
            result := 'Error loading settings. File corrupted.';
          end;
        0080:
          begin
            result := 'Version mismatch between the files';
          end;
        0089:
          begin
        ...
        0167:
          begin
            result := 'Updating files, please wait... ';
          end;
        0174:
          begin
        ...
        0175:
          begin
            result := 'Failed to download the update file!';
          end;
        0176:
          begin
            result := 'Failed to save the update file!';
          end;
        0177:
          begin
            result := 'Server overloaded. Try again later!';
          end;
